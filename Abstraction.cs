...
namespace CSharpPrograms
{
    ...
    /// Methods,Interfaces(100% abstraction,security),Abstract Classes(Partial abstraction) - to achieve abstraction in C#
    /// Abstract Classes - abstract keyword - cannot be instantiated(have to inherit) - can have abstract and non-abstract methods/variables
    /// Abstract class - base class for other classes
    /// Abstract Methods - no method body - must be implemented in derived class    
    ...
    /// </summary>
    internal abstract class Abstraction //Base Class - 2 properties - Electronic City,Jainagar
    {
        // Abstract Method
        ...
        // Non-Abstract Method to Pay Bill
    ...
    internal class DerivedAbstraction : Abstraction //Derived Class - Electronic City Property - Son
    {
    ...
    internal class DerivedAbstraction1 : Abstraction // Derived Class - Jainagar Property - Daughter
    {
        public override void Show()
        {
