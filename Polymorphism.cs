...
namespace CSharpPrograms
{
    ...
    internal class Polymorphism
    {
        ...
        //CLR - Common Language Runtime - Garbage Collector - Free the memory
        ...
        static void Main(string[] args)
        {
            ...
            poly1.Add(10, 20); //Sum of two integers
            poly1.Add(12.5, 15.5); //Sum of two doubles
            poly1.Add(10, 20, 30); //Sum of three integers
            poly1.Add(12.5, 10); //Sum of double and integer
            poly1.Add(10, 15.5); //Sum of integer and double
        }
